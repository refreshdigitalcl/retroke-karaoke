...
export function KaraokeSessionProvider({ children }) {
  ...
  const sync = useCallback(async () => {
          ...
          if (q.data) setQueue(q.data.map(r => ({ id: r.id, name: r.name, avatar: r.avatar, song: r.song, youtubeUrl: r.youtube_url || '' })))
  ...
  return <KaraokeSessionContext.Provider value={value}>{children}</KaraokeSessionContext.Provider>KaraokeSessionContext.Provider>
      }
