  ...
  return (
        <div className="min-h-screen relative overflow-hidden px-8 py-10 flex flex-col" style={{ background: 'var(--bg-page)' }}>
              ...
              <section className="relative z-10 text-center mb-10">
                ...
                {currentSinger ? (
                    <div className="inline-flex items-center gap-5 rounded-2xl px-9 py-5 border-2" style={{ background: 'var(--bg-card)', borderColor: 'var(--accent-magenta)' }}>
                                <div className="w-[58px] h-[58px] rounded-full flex items-center justify-center text-3xl" style={{ background: 'var(--accent-magenta)' }}>
                    ...
                    <div className="inline-block rounded-2xl px-9 py-6 border" style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}>
              ...
              <section className="relative z-10 max-w-lg w-full mx-auto flex-1">
                      ...
                      <div key={entry.id} className="flex items-center gap-3.5 rounded-r-xl py-3 px-4 border-l-4" style={{ background: 'var(--bg-card)', borderColor: 'var(--accent-purple)' }}>
                                    ...
                                    <div className="w-[38px] h-[38px] rounded-full flex items-center justify-center text-lg" style={{ background: 'var(--accent-magenta)' }}>
                                      {entry.avatar}
                                    </div>div>
