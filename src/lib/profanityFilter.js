...
// Retroke Live (Fase 4): reutiliza exactamente el mismo containsProfanity()
// de arriba (mismo filtro que ya protege /registro, sin duplicar la lista
// ni la logica) para validar comentarios del chat en vivo -- largo +
// garabatos. Lo usa tanto el frontend (aviso instantaneo) como
// /api/live-comment.js (la barrera real, ver ese archivo).
